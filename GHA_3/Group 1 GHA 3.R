...
browser_2006 <- read.csv(file = "/Users/jonashusmann/Desktop/GHA_3/browser_2006.csv")
browser_new <- read.csv(file = "/Users/jonashusmann/Desktop/GHA_3/browser_new.csv")
